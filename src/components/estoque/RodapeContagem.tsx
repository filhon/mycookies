...
export function RodapeContagem({
  ...
  return (
    <RodapeFixo>
      ...
      {/* Prosa sempre neutra: some com o teclado aberto, e esta é a tela em
            que digitar é a única coisa que se faz. Ver `DECISOES.md#d75`. */}
      <p className="flex items-start gap-2.5 border-t border-line bg-sunken px-4 py-2.5 text-label text-ink-muted apertado:hidden lg:px-5">
        ...
        <span className="max-w-[64ch]" aria-live="polite">
          {contadas === 0 ? (
            ...
            <>
              Salvar grava{" "}
              <strong className="num font-semibold text-ink">{contadas}</strong>{" "}
