...
const CLASSES =
  "fixed bottom-[calc(4.5rem+env(safe-area-inset-bottom,0px))] left-1/2 z-30 flex h-13 -translate-x-1/2 items-center gap-2 whitespace-nowrap rounded-full bg-accent-500 pl-4 pr-5 text-body font-semibold text-on-accent shadow-raised transition-colors duration-150 ease-quart hover:bg-accent-600 active:bg-accent-600 apertado:hidden lg:hidden";

/**
 * A ação primária ao alcance do polegar, acima da navegação inferior. É o
 * botão primário do celular, então é âmbar como ele.
 *
 ...
 * baixa, de papel: o âmbar sobre o creme já a destaca sozinho.
 *
